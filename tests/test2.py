...
import sys
sys.path.append("..")
from neural_network.neural_network2 import NeuralNetwork
import pdb
...
def test():
    ...
    assert len(evaluation['training_loss']) == n_epochs
    assert len(evaluation['evaluation_accuracy']) == n_epochs
